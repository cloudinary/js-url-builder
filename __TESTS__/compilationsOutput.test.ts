...
describe("Testing", () => {
  ...
  it("https://demo.media.cloudinary.net/f_webm/dog.mp4", () => {
    ...
    expect(tAsset.toURL()).toBe(
      "https://demo.media.cloudinary.net/f_webm/dog.mp4"
    );
  });
  ...
  it("https://demo.media.cloudinary.net/e_bgremoval/casual_yellow.png", () => {
    ...
    tAsset.setURLConfig({ analytics: false });
    expect(tAsset.toURL()).toBe(
      "https://demo.media.cloudinary.net/e_bgremoval/casual_yellow.png"
    );
  });
