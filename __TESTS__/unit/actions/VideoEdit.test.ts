...
describe('Tests for Transformation Action -- VideoEdit', () => {
  ...
  it('Creates a cloudinaryURL with trim', () => {
    ...
    expect(url).toBe('https://demo.media.cloudinary.net/du_10,eo_4,so_3/sample');
  });
  ...
  it('Creates a cloudinaryURL with trim and percent duration', () => {
    ...
    expect(url).toBe('https://demo.media.cloudinary.net/du_10p,eo_4,so_3/sample');
  });
  ...
  it('Creates a cloudinaryURL with trim %', () => {
    ...
    expect(url).toBe('https://demo.media.cloudinary.net/du_10p,eo_4p,so_3p/sample');
  });
  ...
  it('Creates a cloudinaryURL with volume string', () => {
    ...
    expect(url).toBe('https://demo.media.cloudinary.net/e_volume:5db/sample');
  });
  ...
  it('Creates a cloudinaryURL with volume number', () => {
    ...
    expect(url).toBe('https://demo.media.cloudinary.net/e_volume:10/sample');
  });
  ...
  it('Creates a cloudinaryURL with volume Volume.mute()', () => {
    ...
    expect(url).toBe('https://demo.media.cloudinary.net/e_volume:mute/sample');
  });
