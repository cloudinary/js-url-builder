...
describe('Tests for Transformation Action -- Effect', () => {
  ...
  it('Creates a cloudinaryURL with effect colorize', () => {
    ...
    expect(url).toBe('https://demo.media.cloudinary.net/co_red,e_colorize:10/sample');
  });
  ...
  it('Creates a cloudinaryURL with effect colorize:level', () => {
    ...
    expect(url).toBe('https://demo.media.cloudinary.net/e_colorize:50/sample');
  });
  ...
  it('Creates a cloudinaryURL with effect colorize:level', () => {
    ...
    expect(url).toBe('https://demo.media.cloudinary.net/e_colorize:10/sample');
  });
  ...
  it('Creates a cloudinaryURL with effect oilPaint', () => {
    ...
    expect(url).toBe('https://demo.media.cloudinary.net/e_oil_paint:10/sample');
  });
  ...
  it('Creates a cloudinaryURL with effect oilPaint:level', () => {
    ...
    expect(url).toBe('https://demo.media.cloudinary.net/e_oil_paint:50/sample');
  });
  ...
  it('Creates a cloudinaryURL with effect artisticFilter', () => {
    ...
    expect(url).toBe('https://demo.media.cloudinary.net/e_art:peacock/sample');
  });
  ...
  it('Can use shortened artisticFilter notation', () => {
    ...
    expect(url).toBe('https://demo.media.cloudinary.net/e_art:al_dente/sample');
  });
  ...
  it('Creates a cloudinaryURL with effect cartoonify:50', () => {
    ...
    expect(url).toBe('https://demo.media.cloudinary.net/e_cartoonify:50:bw/sample');
  });
