...
describe('Tests for Transformation Action -- Variable', () => {
  ...
  it('Creates a cloudinaryURL with number variable asFloat', () => {
    ...
    expect(url).toBe('https://demo.media.cloudinary.net/$a_30_to_f/sample');
  });
  ...
  it('Creates a cloudinaryURL with number variable asInteger', () => {
    ...
    expect(url).toBe('https://demo.media.cloudinary.net/$a_30_to_i/sample');
  });
  ...
  it('Creates a cloudinaryURL with a string variable', () => {
    ...
    expect(url).toBe('https://demo.media.cloudinary.net/$a_!bbb!/sample');
  });
  ...
  it('Creates a cloudinaryURL with a string variable and asInteger', () => {
    ...
    expect(url).toBe('https://demo.media.cloudinary.net/$a_!bbb!_to_i/sample');
  });
  ...
  it('Creates a cloudinaryURL with a string variable and asFloat', () => {
    ...
    expect(url).toBe('https://demo.media.cloudinary.net/$a_!bbb!_to_f/sample');
  });
  ...
  it('Creates a cloudinaryURL with expression', () => {
    ...
    expect(url).toBe('https://demo.media.cloudinary.net/$myexp_iw_add_100_div_3/sample');
  });
  ...
  it('Creates a cloudinaryURL with expression and asFloat', () => {
    ...
    expect(url).toBe('https://demo.media.cloudinary.net/$myexp_iw_add_100_div_3_to_f/sample');
  });
  ...
  it('Creates a cloudinaryURL with array', () => {
    ...
    expect(url).toBe('https://demo.media.cloudinary.net/$list_!a:b:c!/sample');
  });
  ...
  it('Creates a cloudinaryURL with setReference', () => {
    ...
    expect(url).toBe('https://demo.media.cloudinary.net/$myexp_ref:!my_file!/sample');
  });
  ...
  it('Creates a cloudinaryURL with setReference and asInteger', () => {
    ...
    expect(url).toBe('https://demo.media.cloudinary.net/$myexp_ref:!my_file!_to_i/sample');
  });
  ...
  it('Creates a cloudinaryURL with setReference and asFloat', () => {
    ...
    expect(url).toBe('https://demo.media.cloudinary.net/$myexp_ref:!my_file!_to_f/sample');
  });
  ...
  it('Creates a cloudinaryURL with setFromContext', () => {
    ...
    expect(url).toBe('https://demo.media.cloudinary.net/$myexp_ctx:!my_file!/sample');
  });
  ...
  it('Creates a cloudinaryURL with setFromContext and asInteger', () => {
    ...
    expect(url).toBe('https://demo.media.cloudinary.net/$myexp_ctx:!my_file!_to_i/sample');
  });
  ...
  it('Creates a cloudinaryURL with setFromContext and asFloat', () => {
    ...
    expect(url).toBe('https://demo.media.cloudinary.net/$myexp_ctx:!my_file!_to_f/sample');
  });
  ...
  it('Creates a cloudinaryURL with setFromMetadata', () => {
    ...
    expect(url).toBe('https://demo.media.cloudinary.net/$myexp_md:!my_file!/sample');
  });
  ...
  it('Creates a cloudinaryURL with setFromMetadata and asInteger', () => {
    ...
    expect(url).toBe('https://demo.media.cloudinary.net/$myexp_md:!my_file!_to_i/sample');
  });
  ...
  it('Creates a cloudinaryURL with setFromMetadata and asFloat', () => {
    ...
    expect(url).toBe('https://demo.media.cloudinary.net/$myexp_md:!my_file!_to_f/sample');
  });
