...
describe('Tests for Transformation Action -- Transcode', () => {
  ...
  it('Creates a cloudinaryURL with bitrate', () => {
    ...
    expect(url).toBe('https://demo.media.cloudinary.net/br_500k/sample');
  });
  ...
  it('Creates a cloudinaryURL with bitrate.constant', () => {
    ...
    expect(url).toBe('https://demo.media.cloudinary.net/br_500:constant/sample');
  });
  ...
  it('Creates a cloudinaryURL with audioFrequency', () => {
    ...
    expect(url).toBe('https://demo.media.cloudinary.net/af_11025/sample');
  });
  ...
  it('Creates a cloudinaryURL with fps', () => {
    ...
    expect(url).toBe('https://demo.media.cloudinary.net/fps_20/sample');
  });
  ...
  it('Creates a cloudinaryURL with fpsRange from-to', () => {
    ...
    expect(url).toBe('https://demo.media.cloudinary.net/fps_20-20/sample');
  });
  ...
  it('Creates a cloudinaryURL with keyframeInterval', () => {
    ...
    expect(url).toBe('https://demo.media.cloudinary.net/ki_0.4/ki_0.8/sample');
  });
  ...
  it('Creates a cloudinaryURL with streamingProfile', () => {
    ...
    expect(url).toBe('https://demo.media.cloudinary.net/sp_full_hd/sample');
  });
  ...
  it('Creates a cloudinaryURL with toAnimated', () => {
    ...
    expect(url).toBe('https://demo.media.cloudinary.net/f_gif,fl_animated/sample');
  });
  ...
  it('Creates a cloudinaryURL with toAnimated webp', () => {
    ...
    expect(url).toBe('https://demo.media.cloudinary.net/f_webp,fl_animated,fl_awebp/sample');
  });
  ...
  it('Creates a cloudinaryURL with toAnimated, sampling', () => {
    ...
    expect(url).toBe('https://demo.media.cloudinary.net/f_gif,fl_animated,vs_4s/sample');
  });
