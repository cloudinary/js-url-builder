...
describe('Tests for Transformation Action -- Border', () => {
  ...
  it('Creates a cloudinaryURL with border and rgb #0000ff', () => {
    ...
    expect(url).toBe('https://demo.media.cloudinary.net/bo_7px_solid_rgb:0000ff/sample');
  });
  ...
  it('Creates a cloudinaryURL with border and rgb #FFF', () => {
    ...
    expect(url).toBe('https://demo.media.cloudinary.net/bo_7px_solid_rgb:FFF/sample');
  });
  ...
  it('Creates a cloudinaryURL with border and rgb #FFFFFFFF', () => {
    ...
    expect(url).toBe('https://demo.media.cloudinary.net/bo_7px_solid_rgb:FFFFFFFF/sample');
  });
  ...
  it('Creates a cloudinaryURL with border and rgb #FFFFFFFF and round corners', () => {
    ...
    expect(url).toBe('https://demo.media.cloudinary.net/bo_7px_solid_rgb:FFFFFFFF,r_50/sample');
  });
});
